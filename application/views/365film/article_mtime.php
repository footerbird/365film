...
<html>
        ...
        <div class="article-left">
            ...
            <div class="article-list" id="article_list">
                ...
                <a href="<?php echo base_url() ?>movie_<?php echo $article->article_route; ?>.html" target="_blank" class="article-item">
                    ...
                    <?php if($article->article_rank > 0){ ?>
                    <div class="score">Top<?php echo $article->article_rank; ?></div>
                    <?php } ?>
                </a>
                <?php } ?>
    ...
    $(function(){
        ...
        $(window).on("scroll",function(){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo base_url() ?>365film/Index_controller/get_articleMtimeAjax_tpl",
                async:true,
                data:{
                    page: current_page+1
                },
